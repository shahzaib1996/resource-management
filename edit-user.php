...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE tab_users SET email='$email' , password='$password' WHERE id='$usrid' ";

        if (mysqli_query($con, $sql)) {
          $msg = "<div class='nNote nSuccess'><p>Success! User credentials updated.</p></div>";
      } else {
          $msg = "<div class='nNote nFailure'><p>Error! User credentials failed to updated.</p></div>";
      }
...
if(isset($_GET['userid'])) {
    ...
    $sql1="SELECT * FROM tab_users where id='$userid' ";

    if($re=mysqli_query($con,$sql1)) {
        ...
        <div class="breadLine">
            <div class="bc">
                <ul id="breadcrumbs" class="breadcrumbs">
                    ...
                    <li class="current"><a href="viewusers.php" title="">Edit User</a></li>
                </ul>
            </div>
            ...
            <fieldset>
                <div class="widget fluid">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9"><input type="text" name="email" value="<?php echo $em; ?>" required /></div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow" style="border: 0px;">
                        ...
                        <div class="grid9"><input type="text" name="password" value="<?php echo $pass; ?>" required /></div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow" style="border: 0px !important;">
                        ...
                        <div class="grid9"><input type="submit" name="submit" value="Update" class="buttonL bGreen" style="width: 200px;float:;height:40px;" /></div>
                        <div class="clear"></div>
                    </div>

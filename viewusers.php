...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (isset($_POST['delete'])) {
		...
		$sq = "DELETE FROM tab_users WHERE id='$deluid' ";

		if (mysqli_query($con, $sq)) {
			$msg = "<div class='nNote nSuccess'><p>Success! User Deleted.</p></div>";
		} 
		else {
			$msg = "<div class='nNote nFailure'><p>Error! User failed to Delete.</p></div>";
		}
...
<body>
			...
			<ul class="nav">
				<li><a href="index.php" title="" class="active"><img src="images/icons/mainnav/dashboard.png" alt="" /><span>Dashboard</span></a>
					<ul>
						...
						<li><a href="viewusers.php" title="" class="this"><span class="icon-arrow-right-6"></span>View Users</a></li>
				...
				<div id="tab-container" class="tab-container">
					...
					<div id="general">
						<ul class="subNav">
							...
							<li><a href="adduser.php" title=""><span class="icon-arrow-right-6"></span>Add New User</a></li>
							<?php } else if($_SESSION['type'] == '0') { ?>
							<li><a href="index.php" title="" class="this"><span class="icon-arrow-right-6"></span>Home</a></li>
							<li><a href="create-resource.php" title=""><span class="icon-arrow-right-6"></span>Create Resource</a></li>
							<li><a href="search.php" title=""><span class="icon-arrow-right-6"></span>View Resources</a></li>
							<?php } ?>
						</ul>
	...
	<div id="content">
		<div class="contentTop">
			<span class="pageTitle"><span class="icon-screen"></span>View Users</span>
		...
		<div class="breadLine">
			<div class="bc">
				<ul id="breadcrumbs" class="breadcrumbs">
					...
					<li class="current"><a href="viewusers.php" title="">View Users</a></li>
				</ul>
			</div>
		...
		<div class="wrapper">
			...
			<div class="widget">
				<div class="whead"><h6>Users</h6><div class="clear"></div></div>
						...
						if ($result=mysqli_query($con,$sql))
						{
							...
							while ($row=mysqli_fetch_row($result))
							{
								if($row[4] == "1") {
									...
									echo "<td width='40px' align='center'><a href='edit-user.php?userid=".$row[0]."' >Edit</a></td>";

									echo "<td width='40px' align='center'> <form action='' method='POST' onsubmit='return confirmDelete();' ><input type='hidden' name='deluid' value='".$row[0]."' /> <input type='submit' name='delete' value='Delete' style='background:transparent;color:#2b6893;' /></form></td>";

...
<div class="loginWrapper">
    ...
    <form action="logincheck.php" id="login" method="POST">
        <div class="loginPic">
            <a href="#" title=""><img src="images/ie_logo.png" alt="" /></a>
            <span>ICON EDUCATE</span>
            
        </div>
        
        <input type="text" name="username" placeholder="Enter your username" class="loginUsername" required />
        <input type="password" name="password" placeholder="Enter your password" class="loginPassword" required />

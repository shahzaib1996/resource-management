...
<body>
            ...
            <ul class="nav">
                <li><a href="index.php" title="" class="active"><img src="images/icons/mainnav/dashboard.png" alt="" /><span>Dashboard</span></a>
                    <ul>
                        ...
                        <li><a href="search.php" title="" class="this"><span class="icon-arrow-right-6"></span>Search Resources</a></li>
    ...
    <div id="content">
     ...
     <div class="wrapper">
        ...
        <form action="" method="POST" class="main" enctype="multipart/form-data" name="resource_form">
            <fieldset>
                <div class="widget fluid">
                    <div class="whead"><h6>Resource created on [ <?php echo $created; ?> ]</h6><div class="clear"></div></div>

                    <div class="formRow">
                        <div class="grid3"><label>ID#</label></div>
                        <div class="grid9">
                            <?php echo $rid; ?>
                        </div>
                        <div class="clear"></div>
